    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            if (isset($_GET['category_id'])) {
                $category = $repository->GetCategoryById($_GET['category_id']);
                if (empty($category)) {
                    echo "<h1 class=\"page-header\">This category doesn't exists!</h1>";
                } else {
                    $result = $repository->GetPostsByCategoryId($_GET['category_id']);
                    if (!empty($result))
                    {
                        echo "<h1 class=\"page-header\">Posts <small>in \"$category->title\" category</small></h1>";
                        $posts = $result;
                    }
                    else {
                        echo "<h1 class=\"page-header\">There is no posts in \"$category->title\" category!</h1>";
                    }
                }
            } else {
